...
describe('v3: payment-methods: can get all', () => {
  const legacyId = '4564'
  ...
  it("Tillhub's payment methods are instantiable", async () => {
    if (process.env.SYSTEM_TEST !== 'true') {
      ...
      mock.onGet(`https://api.tillhub.com/api/v3/transactions/${legacyId}/payment-method`).reply(() => {
        return [
          200,
          {
            count: 1,
    ...
    const paymentMethodsV3 = th.paymentMethodsV3()
