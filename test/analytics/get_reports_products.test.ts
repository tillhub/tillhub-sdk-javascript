...
const legacyId = '4564'
const queryString =
  'start=2018-07-29T14%3A55%3A05.000Z&end=2018-08-29T14%3A55%3A05.000Z&branch_number=1&register_number=1&staff_id=1&limit=200&offset=10'
const queryObject = {
...
describe('v0: Analytics Reports Products - getReportsProducts', () => {
  it("Tillhub's Analytics are instantiable", async () => {
    ...
    const { data } = await analytics.getReportsProducts(queryObject)
