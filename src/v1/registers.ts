...
export class Registers extends ThBaseHandler {
  ...
  async get (registerId: string): Promise<RegisterResponse> {
    ...
    try {
      ...
      throw new errors.RegisterFetchFailed(error.message, { error })
    }
  }
  ...
  async notify (registerId: string, notification: Notification): Promise<NotificationResponse> {
    try {
      ...
      throw new errors.RegisterNotificationCreateFailed(error.message, { error })
    }
  }
  ...
  async updateDeviceConfiguration (
    ...
    try {
      ...
      console.warn(error)
      throw new errors.RegisterDeviceConfigurationPutFailed(error.message, { error })
    }
  }
  ...
  async put (registerId: string, register: Register): Promise<RegisterResponse> {
    ...
    try {
      ...
      throw new errors.RegisterPutFailed(error.message, { error })
    }
  }
  ...
  async search (query: string | SearchQuery): Promise<RegisterResponse> {
    ...
    try {
      ...
      throw new errors.RegistersSearchFailed(error.message, { error })
    }
  }
}
