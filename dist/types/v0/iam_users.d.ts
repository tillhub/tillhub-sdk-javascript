...
export declare class IamUsers extends ThBaseHandler {
    ...
    deleteGuestConnection(iamUserId: string): Promise<IamUserResponse>;
...
export declare class IamUserDeleteGuestConnectionFailed extends BaseError {
    message: string;
    name: string;
    constructor(message?: string, properties?: Record<string, unknown>);
}
export declare class IamUserUpdateGuestConnectionFailed extends BaseError {
    message: string;
    name: string;
    constructor(message?: string, properties?: Record<string, unknown>);
}
