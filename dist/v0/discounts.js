...
var Discounts = /** @class */ (function (_super) {
    __extends(Discounts, _super);
    function Discounts(options, http) {
        var _this = _super.call(this, http, { endpoint: Discounts.baseEndpoint, base: options.base || 'https://api.tillhub.com' }) || this;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (response_1.status !== 200) {
                            return [2 /*return*/, reject(new errors.DiscountsFetchFailed(undefined, { status: response_1.status }))];
                        }
                    ...
                    case 2:
                        error_1 = _a.sent();
                        return [2 /*return*/, reject(new errors.DiscountsFetchFailed(undefined, { error: error_1 }))];
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        return [2 /*return*/, reject(new errors.DiscountFetchFailed(undefined, { error: error_2 }))];
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.http.getClient().put(uri, discount)];
                    case 2:
                        response = _a.sent();
                        return [2 /*return*/, resolve({
                                data: response.data.results[0],
                    ...
                    case 3:
                        error_3 = _a.sent();
                        return [2 /*return*/, reject(new errors.DiscountPutFailed(undefined, { error: error_3 }))];
                    case 4: return [2 /*return*/];
                }
            });
        }); });
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.http.getClient().post(uri, discount)];
                    case 2:
                        response = _a.sent();
                        return [2 /*return*/, resolve({
                                data: response.data.results[0],
                    ...
                    case 3:
                        error_4 = _a.sent();
                        return [2 /*return*/, reject(new errors.DiscountCreationFailed(undefined, { error: error_4 }))];
                    case 4: return [2 /*return*/];
                }
            });
        }); });
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (response.status !== 200) {
                            return [2 /*return*/, reject(new errors.DiscountsCountFailed(undefined, { status: response.status }))];
                        }
                        return [2 /*return*/, resolve({
                    ...
                    case 3:
                        error_5 = _a.sent();
                        return [2 /*return*/, reject(new errors.DiscountsCountFailed(undefined, { error: error_5 }))];
                    case 4: return [2 /*return*/];
                }
            });
        }); });
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        return [2 /*return*/, reject(new errors.DiscountDeleteFailed())];
                    case 4: return [2 /*return*/];
                }
            });
        }); });
