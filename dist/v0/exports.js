                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (response.status !== 200) {
                            return [2, reject(new ExportsDatevFetchFailed(undefined, { status: response.status }))];
                        }
                        return [2, resolve({
                    ...
                    case 2:
                        error_1 = _a.sent();
                        return [2, reject(new ExportsDatevFetchFailed(undefined, { error: error_1 }))];
                    case 3: return [2];
                }
            });
        }); });
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        if (response.status !== 200) {
                            return [2, reject(new ExportsGobdFetchFailed(undefined, { status: response.status }))];
                        }
                        return [2, resolve({
                                data: response.data.results,
                                metadata: {}
                    ...
                    case 2:
                        error_2 = _a.sent();
                        return [2, reject(new ExportsGobdFetchFailed(undefined, { error: error_2 }))];
                    case 3: return [2];
                }
            });
        }); });
