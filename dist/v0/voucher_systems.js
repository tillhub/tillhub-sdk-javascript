...
var VoucherSystems = /** @class */ (function (_super) {
    __extends(VoucherSystems, _super);
    function VoucherSystems(options, http) {
        var _this = _super.call(this, http, { endpoint: VoucherSystems.baseEndpoint, base: options.base || 'https://api.tillhub.com' }) || this;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (response_1.status !== 200) {
                            return [2 /*return*/, reject(new VoucherSystemsFetchFailed(undefined, { status: response_1.status }))];
                        }
                    ...
                    case 2:
                        error_1 = _a.sent();
                        return [2 /*return*/, reject(new VoucherSystemsFetchFailed(undefined, { error: error_1 }))];
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        return [2 /*return*/, reject(new VoucherSystemFetchFailed(undefined, { error: error_2 }))];
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.http.getClient().put(uri, voucherSystemGroup)];
                    case 2:
                        response = _a.sent();
                        return [2 /*return*/, resolve({
                                data: response.data.results[0],
                    ...
                    case 3:
                        error_3 = _a.sent();
                        return [2 /*return*/, reject(new VoucherSystemPutFailed(undefined, { error: error_3 }))];
                    case 4: return [2 /*return*/];
                }
            });
        }); });
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.http.getClient().post(uri, voucherSystemGroup)];
                    case 2:
                        response = _a.sent();
                        return [2 /*return*/, resolve({
                                data: response.data.results[0],
                    ...
                    case 3:
                        error_4 = _a.sent();
                        return [2 /*return*/, reject(new VoucherSystemCreationFailed(undefined, { error: error_4 }))];
                    case 4: return [2 /*return*/];
                }
            });
        }); });
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        return [2 /*return*/, reject(new VoucherSystemDeleteFailed())];
                    case 4: return [2 /*return*/];
                }
            });
        }); });
...
var VoucherSystemsFetchFailed = /** @class */ (function (_super) {
    __extends(VoucherSystemsFetchFailed, _super);
...
var VoucherSystemFetchFailed = /** @class */ (function (_super) {
    __extends(VoucherSystemFetchFailed, _super);
