                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (response.status !== 200) {
                            return [2, reject(new errors.AccountsFetchFailed(undefined, { status: response.status }))];
                        }
                        return [2, resolve({
                    ...
                    case 2:
                        error_1 = _a.sent();
                        return [2, reject(new errors.AccountsFetchFailed(undefined, { error: error_1 }))];
                    case 3: return [2];
                }
            });
        }); });
        ...
        return new Promise(function (resolve, reject) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        return [2, reject(new errors.AccountFetchFailed(undefined, { error: error_2 }))];
                    case 4: return [2];
                }
            });
        }); });
        ...
        return new Promise(function (resolve, reject) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        return [2, reject(new errors.AccountPutFailed(undefined, { error: error_3 }))];
                    case 4: return [2];
                }
            });
        }); });
        ...
        return new Promise(function (resolve, reject) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        return [2, reject(new errors.AccountCreationFailed(undefined, { error: error_4 }))];
                    case 4: return [2];
                }
            });
        }); });
        ...
        return new Promise(function (resolve, reject) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        return [2, reject(new errors.AccountDeleteFailed())];
                    case 4: return [2];
                }
            });
        }); });
