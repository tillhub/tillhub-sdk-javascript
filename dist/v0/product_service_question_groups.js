...
var errors = __importStar(require("../errors/productServiceQuestionGroups"));
var uri_helper_1 = require("../uri-helper");
var base_1 = require("../base");
var ProductServiceQuestionGroups = /** @class */ (function (_super) {
    __extends(ProductServiceQuestionGroups, _super);
    function ProductServiceQuestionGroups(options, http) {
        var _this = _super.call(this, http, { endpoint: ProductServiceQuestionGroups.baseEndpoint, base: options.base || 'https://api.tillhub.com' }) || this;
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        return [2 /*return*/, reject(new errors.ProductServiceQuestionGroupsFetchAllFailed(undefined, { error: error_1 }))];
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_2 = _a.sent();
                        return [2 /*return*/, reject(new errors.ProductServiceQuestionGroupsFetchOneFailed(undefined, { error: error_2 }))];
                    case 3: return [2 /*return*/];
                }
            });
        }); });
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_3 = _a.sent();
                        return [2 /*return*/, reject(new errors.ProductServiceQuestionGroupsGetMetaFailed(undefined, { error: error_3 }))];
                    case 3: return [2 /*return*/];
                }
            });
        }); });
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_4 = _a.sent();
                        return [2 /*return*/, reject(new errors.ProductServiceQuestionGroupsCreationFailed(undefined, { error: error_4 }))];
                    case 3: return [2 /*return*/];
                }
            });
        }); });
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_5 = _a.sent();
                        return [2 /*return*/, reject(new errors.ProductServiceQuestionGroupsPutFailed(undefined, { error: error_5 }))];
                    case 3: return [2 /*return*/];
                }
            });
        }); });
