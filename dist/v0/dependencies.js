...
var Dependencies = /** @class */ (function (_super) {
    ...
    function Dependencies(options, http) {
        var _this = _super.call(this, http, { endpoint: Dependencies.baseEndpoint, base: options.base || 'https://api.tillhub.com' }) || this;
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        return [2 /*return*/, reject(new DependenciesFetchFailed(undefined, { error: error_1 }))];
...
var DependenciesFetchFailed = /** @class */ (function (_super) {
    __extends(DependenciesFetchFailed, _super);
