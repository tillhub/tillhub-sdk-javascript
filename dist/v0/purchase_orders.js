...
exports.PurchaseOrdersProductsUpsertFailed = exports.PurchaseOrdersUpdateFailed = exports.PurchaseOrdersCreationFailed = exports.PurchaseOrdersGetFailed = exports.PurchaseOrders = void 0;
...
var PurchaseOrders = (function (_super) {
    ...
    PurchaseOrders.prototype.upsertProducts = function (purchaseOrderId, purchaseOrder) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        throw new PurchaseOrdersProductsUpsertFailed(error_4.message, { error: error_4 });
                    case 4: return [2];
                }
            });
        });
...
var PurchaseOrdersProductsUpsertFailed = (function (_super) {
    tslib_1.__extends(PurchaseOrdersProductsUpsertFailed, _super);
    function PurchaseOrdersProductsUpsertFailed(message, properties) {
        if (message === void 0) { message = 'Could upsert products for purchase order'; }
        var _this = _super.call(this, message, properties) || this;
        _this.message = message;
        _this.name = 'PurchaseOrdersProductsUpsertFailed';
        Object.setPrototypeOf(_this, PurchaseOrdersProductsUpsertFailed.prototype);
        return _this;
    }
    return PurchaseOrdersProductsUpsertFailed;
}(errors_1.BaseError));
exports.PurchaseOrdersProductsUpsertFailed = PurchaseOrdersProductsUpsertFailed;
