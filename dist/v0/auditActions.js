                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (response_1.data.cursor && response_1.data.cursor.next) {
                            next = function () {
                                return _this.getAll(__assign(__assign({}, q), { uri: response_1.data.cursor.next }));
                            };
                        }
                    ...
                    case 2:
                        err_1 = _a.sent();
                        return [2 /*return*/, reject(new errors.AuditActionsFetchAllFailed())];
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        return [2 /*return*/, reject(new errors.AuditActionsFetchOneFailed())];
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        return [2 /*return*/, reject(new errors.AuditActionsCreateFailed())];
                    case 4: return [2 /*return*/];
                }
            });
        }); });
