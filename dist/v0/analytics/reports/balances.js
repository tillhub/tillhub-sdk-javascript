        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_1 = _a.sent();
                        return [2 /*return*/, reject(new errors.ReportsBalancesFetchAllFailed())];
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        uri = this.uriHelper.generateBaseUri('/reports/balances/meta');
                        return [4 /*yield*/, this.http.getClient().get(uri)];
                    case 1:
                        response = _a.sent();
                        if (response.status !== 200)
                            return [2 /*return*/, reject(new errors.ReportsBalancesMetaFailed(undefined, { status: response.status }))];
                        if (!response.data.results[0]) {
                            return [2 /*return*/, reject(new errors.ReportsBalancesMetaFailed('Could not get balances metadata unexpectedly'))];
                        }
                        return [2 /*return*/, resolve({
                    ...
                    case 2:
                        err_2 = _a.sent();
                        return [2 /*return*/, reject(new errors.ReportsBalancesMetaFailed())];
                    case 3: return [2 /*return*/];
                }
            });
        }); });
