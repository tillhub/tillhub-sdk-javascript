                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (response.status !== 200) {
                            return [2 /*return*/, reject(new errors.VatReportFetchMetaFailed(undefined, { status: response.status }))];
                        }
                        if (!response.data.results[0]) {
                            return [2 /*return*/, reject(new errors.VatReportFetchMetaFailed('Could not get vat metadata unexpectedly'))];
                        }
                        return [2 /*return*/, resolve({
                    ...
                    case 2:
                        err_2 = _a.sent();
                        return [2 /*return*/, reject(new errors.VatReportFetchMetaFailed())];
                    case 3: return [2 /*return*/];
                }
            });
        }); });
