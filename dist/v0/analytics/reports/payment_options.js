        ...
        return new Promise(function (resolve, reject) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_1 = _a.sent();
                        return [2, reject(new errors.ReportsPaymentOptionsFetchAllFailed())];
                    case 3: return [2];
                }
            });
        }); });
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (response.status !== 200)
                            return [2, reject(new errors.ReportsPaymentOptionsMetaFailed(undefined, { status: response.status }))];
                        if (!response.data.results[0]) {
                            return [2, reject(new errors.ReportsPaymentOptionsMetaFailed('Could not get balances metadata unexpectedly'))];
                        }
                        return [2, resolve({
                    ...
                    case 2:
                        err_2 = _a.sent();
                        return [2, reject(new errors.ReportsPaymentOptionsMetaFailed())];
                    case 3: return [2];
                }
            });
        }); });
