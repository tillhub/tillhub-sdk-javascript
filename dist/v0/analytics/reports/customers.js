        ...
        return new Promise(function (resolve, reject) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_1 = _a.sent();
                        return [2, reject(new errors.CustomerFetchFailed())];
                    case 3: return [2];
                }
            });
        }); });
        ...
        return new Promise(function (resolve, reject) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_2 = _a.sent();
                        return [2, reject(new errors.CustomerFilterFetchFailed())];
                    case 3: return [2];
                }
            });
        }); });
        ...
        return new Promise(function (resolve, reject) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_3 = _a.sent();
                        return [2, reject(new errors.CustomerTransactionFetchFailed())];
                    case 3: return [2];
                }
            });
        }); });
        ...
        return new Promise(function (resolve, reject) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_4 = _a.sent();
                        return [2, reject(new errors.CustomerOverviewFetchFailed())];
                    case 3: return [2];
                }
            });
        }); });
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (response.status !== 200) {
                            return [2, reject(new errors.CustomersMetaFailed(undefined, { status: response.status }))];
                        }
                    ...
                    case 3:
                        err_5 = _a.sent();
                        return [2, reject(new errors.CustomersMetaFailed(undefined, { error: err_5 }))];
                    case 4: return [2];
                }
            });
        }); });
