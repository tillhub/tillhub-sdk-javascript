    ...
    Auth.prototype.authenticate = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.options.type === auth_1.AuthTypes.username)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.loginUsername(this.options.credentials)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        if (!(this.options.type === auth_1.AuthTypes.token)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.loginServiceAccount(this.options.credentials)];
                    case 3: return [2 /*return*/, _a.sent()];
                    case 4:
                        if (!(this.options.type === auth_1.AuthTypes.org)) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.loginWithOrganisation(this.options.credentials)];
                    case 5: return [2 /*return*/, _a.sent()];
                    case 6:
                        if (!(this.options.type === auth_1.AuthTypes.support)) return [3 /*break*/, 8];
                        return [4 /*yield*/, this.loginAsSupport(this.options.credentials)];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.post(this.getEndpoint('/api/v1/users/auth/key'), {
                                id: authData.id,
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        _f.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.post(this.getEndpoint('/api/v1/users/auth/organisation/login'), {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.post(this.getEndpoint('/api/v1/users/auth/support/login'), {
