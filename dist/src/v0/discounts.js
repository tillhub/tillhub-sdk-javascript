                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (response_1.status !== 200) {
                            throw new errors.DiscountsFetchFailed(undefined, { status: response_1.status });
                        }
                    ...
                    case 2:
                        error_1 = _b.sent();
                        throw new errors.DiscountsFetchFailed(undefined, { error: error_1 });
    ...
    Discounts.prototype.get = function (discountId) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        uri = this.uriHelper.generateBaseUri("/" + discountId);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.http.getClient().get(uri)];
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new errors.DiscountFetchFailed(undefined, { error: error_2 });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new errors.DiscountPutFailed(undefined, { error: error_3 });
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        throw new errors.DiscountCreationFailed(undefined, { error: error_4 });
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_5 = _a.sent();
                        throw new errors.DiscountsCountFailed(undefined, { error: error_5 });
                    case 4: return [2 /*return*/];
                }
            });
        });
