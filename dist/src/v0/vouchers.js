            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        uri = this.uriHelper.generateBaseUri("/" + voucherId + "/customers");
                        return [4 /*yield*/, this.http.getClient().post(uri, customers)];
                    case 1:
                        response = _a.sent();
                        if (response.status !== 200) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        uri = this.uriHelper.generateBaseUri("/" + voucherId + "/customers");
                        return [4 /*yield*/, this.http.getClient().put(uri, customers)];
                    case 1:
                        response = _a.sent();
                        if (response.status !== 200) {
...
var VouchersBoundedCustomerGetFailed = /** @class */ (function (_super) {
...
var VouchersBoundedCustomerCreateFailed = /** @class */ (function (_super) {
...
var VouchersBoundedCustomerPutFailed = /** @class */ (function (_super) {
