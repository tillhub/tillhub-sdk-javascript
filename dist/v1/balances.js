...
var Balances = /** @class */ (function (_super) {
    __extends(Balances, _super);
    function Balances(options, http) {
        var _this = _super.call(this, http, { endpoint: Balances.baseEndpoint, base: options.base || 'https://api.tillhub.com' }) || this;
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        return [2 /*return*/, reject(new errors.BalancesFetchFailed())];
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (response.status !== 200)
                            return [2 /*return*/, reject(new errors.BalancesMetaFailed(undefined, { status: response.status }))];
                        if (!response.data.results[0]) {
                            return [2 /*return*/, reject(new errors.BalancesMetaFailed('could not get balances metadata unexpectedly'))];
                        }
                        return [2 /*return*/, resolve({
                    ...
                    case 3:
                        err_2 = _a.sent();
                        return [2 /*return*/, reject(new errors.BalancesMetaFailed())];
                    case 4: return [2 /*return*/];
                }
            });
        }); });
