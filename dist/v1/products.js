...
exports.BarcodeGetFailed = exports.ProductsBookStockFailed = exports.ProductsSearchFailed = exports.ProductsDeleteFailed = exports.ProductsBulkDeleteFailed = exports.ProductsBulkEditFailed = exports.ProductsBulkCreateFailed = exports.ProductsUpdateFailed = exports.ProductsMetaFailed = exports.ProductsCountFailed = exports.ProductChildrenDetailsFetchFailed = exports.ProductDetailsFetchFailed = exports.ProductsExportFailed = exports.ProductsImportFailed = exports.ProductsFetchFailed = exports.ProductFetchFailed = exports.ProductsDuplicateFailed = exports.ProductsCreateFailed = exports.Products = void 0;
...
var Products = (function (_super) {
    ...
    Products.prototype.duplicate = function (body) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var uri, response, error_2;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        uri = this.uriHelper.generateBaseUri('/duplicate');
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new ProductsDuplicateFailed(error_2.message, { error: error_2 });
                    case 4: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        error_3 = _b.sent();
                        throw new ProductsFetchFailed(error_3.message, { error: error_3 });
                    case 3: return [2];
                }
            });
        });
    ...
    Products.prototype.query = function (options) {
        var _a, _b, _c, _d, _e;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var next, splitBodyAndQuery, uri, bodyPayload, flat, _f, body, query, base, response_2, error_4;
            var _this = this;
            return tslib_1.__generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        ...
                        uri = void 0;
                        bodyPayload = void 0;
                        if ((_a = options === null || options === void 0 ? void 0 : options.uri) !== null && _a !== void 0 ? _a : (_b = options === null || options === void 0 ? void 0 : options.query) === null || _b === void 0 ? void 0 : _b.uri) {
                            uri = ((_c = options === null || options === void 0 ? void 0 : options.uri) !== null && _c !== void 0 ? _c : (_d = options === null || options === void 0 ? void 0 : options.query) === null || _d === void 0 ? void 0 : _d.uri);
                            bodyPayload = {};
                        }
                        else {
                            ...
                            _f = splitBodyAndQuery(flat), body = _f.body, query = _f.query;
                        ...
                        return [4, this.http.getClient().post(uri, bodyPayload)];
                    case 2:
                        response_2 = _g.sent();
                        if (response_2.status !== 200) {
                            throw new ProductsFetchFailed(undefined, { status: response_2.status });
                        }
                        if ((_e = response_2.data.cursor) === null || _e === void 0 ? void 0 : _e.next) {
                    ...
                    case 3:
                        error_4 = _g.sent();
                        throw new ProductsFetchFailed(error_4.message, { error: error_4 });
                    case 4: return [2];
                }
            });
        });
    ...
    Products.prototype.select = function (options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var base, query, body, uri, response, error_5;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 2:
                        error_5 = _a.sent();
                        throw new ProductsFetchFailed(error_5.message, { error: error_5 });
                    case 3: return [2];
                }
            });
        });
    ...
    Products.prototype.import = function (options) {
        var _a;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var next, base, uri, response_3, error_6;
            var _this = this;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        if (response_3.status !== 200) {
                            throw new ProductsImportFailed(undefined, { status: response_3.status });
                        }
                        if ((_a = response_3.data.cursor) === null || _a === void 0 ? void 0 : _a.next) {
                            next = function () { return _this.import({ uri: response_3.data.cursor.next }); };
                        }
                        return [2, {
                                data: response_3.data.results,
                                metadata: { count: response_3.data.count, cursor: response_3.data.cursor },
                                next: next
                            }];
                    case 2:
                        error_6 = _b.sent();
                        throw new ProductsImportFailed(error_6.message, { error: error_6 });
                    case 3: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_7 = _a.sent();
                        throw new ProductFetchFailed(error_7.message, { error: error_7 });
                    case 4: return [2];
                }
            });
        });
    };
    Products.prototype.export = function (query) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_8 = _a.sent();
                        throw new ProductsExportFailed(error_8.message, { error: error_8 });
                    case 4: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_9 = _a.sent();
                        throw new ProductDetailsFetchFailed(error_9.message, { error: error_9 });
                    case 4: return [2];
                }
            });
        });
    ...
    Products.prototype.getChildrenDetails = function (productId, hideStock, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var query, base, uri, response, error_10;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        error_10 = _a.sent();
                        throw new ProductChildrenDetailsFetchFailed(error_10.message, { error: error_10 });
                    case 4: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_11 = _a.sent();
                        throw new ProductsMetaFailed(error_11.message, { error: error_11 });
                    case 4: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_12 = _a.sent();
                        throw new ProductsUpdateFailed(error_12.message, { error: error_12 });
                    case 4: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_13 = _a.sent();
                        throw new ProductsBulkCreateFailed(error_13.message, { error: error_13 });
                    case 4: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_14 = _a.sent();
                        throw new ProductsBulkEditFailed(error_14.message, { error: error_14 });
                    case 4: return [2];
                }
            });
        });
    };
    Products.prototype.bulkDelete = function (body) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_15 = _a.sent();
                        throw new ProductsBulkDeleteFailed(error_15.message, { error: error_15 });
                    case 4: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_16 = _a.sent();
                        throw new ProductsCountFailed(error_16.message, { error: error_16 });
                    case 4: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_17 = _a.sent();
                        throw new ProductsDeleteFailed(error_17.message, { error: error_17 });
                    case 3: return [2];
                }
            });
        });
    ...
    Products.prototype.search = function (query) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _query, base, uri, response, error_18;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        error_18 = _a.sent();
                        throw new ProductsSearchFailed(error_18.message, { error: error_18 });
                    case 4: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_19 = _a.sent();
                        throw new ProductsBookStockFailed(error_19.message, { error: error_19 });
                    case 4: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_20 = _a.sent();
                        if (error_20.response && error_20.response.status === 409) {
                            throw new BarcodeGetFailed(undefined, {
                                status: error_20.response.status,
                                name: error_20.response.data.name,
                                data: error_20.response.data.results
                            });
                        }
                        throw new BarcodeGetFailed(error_20.message, { error: error_20 });
                    case 4: return [2];
                }
            });
        });
...
var ProductsDuplicateFailed = (function (_super) {
    tslib_1.__extends(ProductsDuplicateFailed, _super);
    function ProductsDuplicateFailed(message, properties) {
        if (message === void 0) { message = 'Could not duplicate the products'; }
        var _this = _super.call(this, message, properties) || this;
        _this.message = message;
        _this.name = 'ProductsDuplicateFailed';
        Object.setPrototypeOf(_this, ProductsDuplicateFailed.prototype);
        return _this;
    }
    return ProductsDuplicateFailed;
}(baseError_1.BaseError));
exports.ProductsDuplicateFailed = ProductsDuplicateFailed;
...
var ProductsExportFailed = (function (_super) {
    tslib_1.__extends(ProductsExportFailed, _super);
    function ProductsExportFailed(message, properties) {
        if (message === void 0) { message = 'Could not export the products'; }
        var _this = _super.call(this, message, properties) || this;
        _this.message = message;
        _this.name = 'ProductsExportFailed';
        Object.setPrototypeOf(_this, ProductsExportFailed.prototype);
        return _this;
    }
    return ProductsExportFailed;
}(baseError_1.BaseError));
exports.ProductsExportFailed = ProductsExportFailed;
...
var ProductsBulkDeleteFailed = (function (_super) {
    tslib_1.__extends(ProductsBulkDeleteFailed, _super);
    function ProductsBulkDeleteFailed(message, properties) {
        if (message === void 0) { message = 'Could not bulk delete the products'; }
        var _this = _super.call(this, message, properties) || this;
        _this.message = message;
        _this.name = 'ProductsBulkDeleteFailed';
        Object.setPrototypeOf(_this, ProductsBulkDeleteFailed.prototype);
        return _this;
    }
    return ProductsBulkDeleteFailed;
}(baseError_1.BaseError));
exports.ProductsBulkDeleteFailed = ProductsBulkDeleteFailed;
