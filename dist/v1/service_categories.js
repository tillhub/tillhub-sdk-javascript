...
exports.ServiceCategoryDeleteFailed = exports.ServiceCategoryPutFailed = exports.ServiceCategoryCreationFailed = exports.ServiceCategoryFetchFailed = exports.ServiceCategoriesMetaFailed = exports.ServiceCategoriesFetchAllFailed = exports.ServiceCategories = void 0;
...
var ServiceCategories = (function (_super) {
    ...
    ServiceCategories.prototype.meta = function (q) {
        var _a;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        error_2 = _b.sent();
                        throw new ServiceCategoriesMetaFailed(error_2.message, { error: error_2 });
                    case 4: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new ServiceCategoryFetchFailed(error_3.message, { error: error_3 });
                    case 4: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        throw new ServiceCategoryCreationFailed(error_4.message, { error: error_4 });
                    case 4: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_5 = _a.sent();
                        throw new ServiceCategoryPutFailed(error_5.message, { error: error_5 });
                    case 4: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_6 = _a.sent();
                        throw new ServiceCategoryDeleteFailed(error_6.message, { error: error_6 });
                    case 4: return [2];
                }
            });
        });
...
var ServiceCategoriesMetaFailed = (function (_super) {
    tslib_1.__extends(ServiceCategoriesMetaFailed, _super);
    function ServiceCategoriesMetaFailed(message, properties) {
        if (message === void 0) { message = 'Could not get service categories metadata'; }
        var _this = _super.call(this, message, properties) || this;
        _this.message = message;
        _this.name = 'ServiceCategoriesMetaFailed';
        Object.setPrototypeOf(_this, ServiceCategoriesMetaFailed.prototype);
        return _this;
    }
    return ServiceCategoriesMetaFailed;
}(baseError_1.BaseError));
exports.ServiceCategoriesMetaFailed = ServiceCategoriesMetaFailed;
