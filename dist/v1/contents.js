...
exports.ContentsMetaFailed = exports.ContentDeleteFailed = exports.ContentCreationFailed = exports.ContentPatchFailed = exports.ContentFetchFailed = exports.ContentsFetchFailed = exports.Contents = void 0;
...
var Contents = (function (_super) {
    ...
    Contents.prototype.meta = function (queryOrOptions) {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (response.status !== 200) {
                            throw new ContentsMetaFailed(undefined, { status: response.status });
                        }
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new ContentsMetaFailed(error_1.message, { error: error_1 });
                    case 4: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        error_2 = _b.sent();
                        throw new ContentsFetchFailed(error_2.message, { error: error_2 });
                    case 3: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new ContentFetchFailed(error_3.message, { error: error_3 });
                    case 4: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        throw new ContentPatchFailed(error_4.message, { error: error_4 });
                    case 4: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_5 = _a.sent();
                        throw new ContentCreationFailed(error_5.message, { error: error_5 });
                    case 4: return [2];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_6 = _a.sent();
                        throw new ContentDeleteFailed(error_6.message, { error: error_6 });
                    case 4: return [2];
                }
            });
        });
    };
    Contents.baseEndpoint = '/api/v1/contents';
    return Contents;
...
var ContentsMetaFailed = (function (_super) {
    tslib_1.__extends(ContentsMetaFailed, _super);
    function ContentsMetaFailed(message, properties) {
        if (message === void 0) { message = 'Could not fetch the content templates meta'; }
        var _this = _super.call(this, message, properties) || this;
        _this.message = message;
        _this.name = 'ContentsMetaFailed';
        Object.setPrototypeOf(_this, ContentsMetaFailed.prototype);
        return _this;
    }
    return ContentsMetaFailed;
}(errors_1.BaseError));
exports.ContentsMetaFailed = ContentsMetaFailed;
