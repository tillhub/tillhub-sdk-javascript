...
var taxObj = {
    ...
    fa_account_number: faker_1.default.random.number().toString(),
    type: 'vat',
    account: faker_1.default.finance.account(),
    rate: faker_1.default.random.number().toString(),
    percentage: '25%',
    is_fixed: faker_1.default.random.boolean(),
    jurisdiction: 'germany',
    rate_class: 'normal'
};
describe('v0: Taxes: can create one tax class', function () {
    it("Tillhub's taxes is instantiable", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var th, Taxes, data;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Taxes.create(taxObj)];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    th = _a.sent();
                    return [4 /*yield*/, th.taxes().create(taxObj)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('TaxesCreationFailed');
                    return [3 /*break*/, 5];
