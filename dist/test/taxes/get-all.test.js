            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onGet("https://api.tillhub.com/api/v0/taxes/" + legacyId).reply(function () {
                            return [
                                200,
                                {
                                    count: 1,
