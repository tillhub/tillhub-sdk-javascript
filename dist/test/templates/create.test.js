...
describe('v1: Templates: can craete template', function () {
    it('create', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var options, templates, data;
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onPost("https://api.tillhub.com/api/v1/templates/" + legacyId).reply(function () {
                            return [
                                200,
                                {
                                    results: templateObj
                ...
                case 1:
                    _a.sent();
                    templates = tillhub_js_1.default.templates();
                    expect(templates).toBeInstanceOf(tillhub_js_1.v1.Templates);
                    return [4 /*yield*/, templates.create(templateObj)];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.templates().create(templateObj)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('TemplatesCreationFailed');
                    return [3 /*break*/, 5];
