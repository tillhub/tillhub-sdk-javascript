...
describe('v1: Products: can bulk edit multiple products', function () {
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onPut("https://api.tillhub.com/api/v1/products/" + legacyId + "/bulk").reply(function () {
                            return [
                                202,
                                {
                                    count: 1,
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Products.bulkEdit(products)];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    th = _a.sent();
                    return [4 /*yield*/, th.products().bulkEdit(products)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('ProductsBulkEditFailed');
                    return [3 /*break*/, 5];
...
//# sourceMappingURL=bulk-edit.test.js.map