...
describe('v0: Products: can import', function () {
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onGet("https://api.tillhub.com/api/v1/products/" + legacyId + "/import").reply(function () {
                            return [
                                200,
                                {
                                    count: 1,
                ...
                case 1:
                    ...
                    return [4 /*yield*/, products.import()];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('Get products with query options', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var queryProp1, queryValue1, queryProp2, queryValue2, queryOptions, options, th, products, data;
        var _a;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    queryValue2 = 'qwer';
                    queryOptions = (_a = {},
                        _a[queryProp1] = queryValue1,
                        _a[queryProp2] = queryValue2,
                        _a);
                    if (process.env.SYSTEM_TEST !== 'true') {
                        mock.onPost('https://api.tillhub.com/api/v0/users/login').reply(function () {
                            return [
                        ...
                        mock
                            .onGet("https://api.tillhub.com/api/v1/products/" + legacyId + "/import?" + queryProp1 + "=" + queryValue1 + "&" + queryProp2 + "=" + queryValue2)
                            .reply(function () {
                            return [
                                200,
                                {
                ...
                case 1:
                    ...
                    products = th.products();
                    expect(products).toBeInstanceOf(tillhub_js_1.v1.Products);
                    return [4 /*yield*/, products.import({ query: queryOptions })];
                case 2:
                    data = (_b.sent()).data;
                    expect(Array.isArray(data)).toBe(true);
                    return [2 /*return*/];
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.products().import()];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('ProductsImportFailed');
                    return [3 /*break*/, 5];
