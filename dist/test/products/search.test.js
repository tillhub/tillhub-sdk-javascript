...
var legacyId = '4564';
var searchTerm = 'asdf';
var searchQuery = { q: searchTerm, types: ['variant'] };
var mock = new axios_mock_adapter_1.default(axios_1.default);
afterEach(function () {
    mock.reset();
});
describe('v1: Products: can search for products', function () {
    it('search by a search query object', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock
                            .onGet("https://api.tillhub.com/api/v1/products/" + legacyId + "/search?" + qs_1.default.stringify(searchQuery))
                            .reply(function () {
                            return [
                                200,
                                {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, products.search(searchQuery)];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('search by a search query string', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var options, th, products, data;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    products = th.products();
                    expect(products).toBeInstanceOf(tillhub_js_1.v1.Products);
                    return [4 /*yield*/, products.search(searchTerm)];
                case 2:
                    data = (_a.sent()).data;
                    expect(Array.isArray(data)).toBe(true);
                    return [2 /*return*/];
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.products().search(searchQuery)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('ProductsSearchFailed');
                    return [3 /*break*/, 5];
