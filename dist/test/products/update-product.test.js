            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onPut("https://api.tillhub.com/api/v1/products/" + legacyId + "/" + productId).reply(function () {
                            return [
                                200,
                                {
                                    results: [
                                        tslib_1.__assign({ id: productId }, requestObject)
                                    ]
                                }
                            ];
                        });
                ...
                case 1:
                    _a.sent();
                    product = tillhub_js_1.default.products();
                    expect(product).toBeInstanceOf(tillhub_js_1.v1.Products);
                    return [4 /*yield*/, product.put(productId, requestObject)];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.products().put(productId, requestObject)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('ProductsUpdateFailed');
                    return [3 /*break*/, 5];
