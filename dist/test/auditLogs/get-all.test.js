...
describe('v0: Audits: Logs: can get all', function () {
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock
                            .onGet("https://api.tillhub.com/api/v0/audits/" + legacyId + "/logs?" + queryString())
                            .reply(function () {
                            return [
                                200,
                                {
                ...
                case 1:
                    _a.sent();
                    audits = th.auditLogs();
                    expect(audits).toBeInstanceOf(tillhub_js_1.v0.AuditLogs);
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.auditLogs().getAll(query)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('AuditLogsFetchAllFailed');
                    return [3 /*break*/, 5];
