...
var locationId = '8f9a8dd4-d1c8-4f49-ab40-8cdcd9c90316';
var query = {
    location: locationId
};
describe('v0: Safes: can get all', function () {
    it("Tillhub's Safes are instantiable", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var options, th, safes, data;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, safes.getAll(query)];
                case 2:
                    data = (_a.sent()).data;
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onGet("https://api.tillhub.com/api/v0/safes/" + legacyId).reply(function () {
                            return [205];
                        });
                    }
                    options = {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.safes().getAll()];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('SafesFetchAllFailed');
                    return [3 /*break*/, 5];
