...
var safeId = 'f8314183-8199-4cb7-b152-04f6ad4ebc7e';
var safe = {
    name: 'testName1'
};
describe('v0: Safes: can get one safe', function () {
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onGet("https://api.tillhub.com/api/v0/safes/" + legacyId + "/" + safeId).reply(function () {
                            return [
                                200,
                                {
                                    count: 1,
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Safes.get(safeId)];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    th = _a.sent();
                    return [4 /*yield*/, th.safes().get(safeId)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('SafesFetchOneFailed');
                    return [3 /*break*/, 5];
