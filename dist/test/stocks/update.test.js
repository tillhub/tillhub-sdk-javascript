...
describe('v0: Stocks', function () {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onPut("https://api.tillhub.com/api/v0/stock/" + legacyId + "/" + stockId).reply(function () {
                            return [
                                200,
                                {
                                    results: body
                ...
                case 1:
                    _a.sent();
                    stock = tillhub_js_1.default.stocks();
                    expect(stock).toBeInstanceOf(tillhub_js_1.v0.Stocks);
                    return [4 /*yield*/, stock.update(requestObject)];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var stockId, options, th, err_1;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    stockId = requestObject.stockId;
                    if (process.env.SYSTEM_TEST !== 'true') {
                        mock
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.stocks().update(requestObject)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('StocksUpdateFailed');
                    return [3 /*break*/, 5];
