...
describe('v0: StocksBook: can get meta', function () {
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onGet("https://api.tillhub.com/api/v0/stock/" + legacyId + "/book/meta").reply(function () {
                            return [
                                200,
                                {
                                    results: [{ count: 900 }]
                ...
                case 1:
                    ...
                    return [4 /*yield*/, stocksBook.meta()];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    th = _a.sent();
                    return [4 /*yield*/, th.stocksBook().meta()];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('StocksBookGetMetaFailed');
                    return [3 /*break*/, 5];
