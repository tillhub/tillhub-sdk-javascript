...
var legacyId = '4564';
describe('v0: Product Service Question: can get count number of all product Service Question', function () {
    var mock = new axios_mock_adapter_1.default(axios_1.default);
    afterEach(function () {
        mock.reset();
    });
    it("Tillhub's productServiceQuestions are instantiable", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var options, th, productServiceQuestions, data;
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock
                            .onGet("https://api.tillhub.com/api/v0/product_service_questions/" + legacyId + "/meta")
                            .reply(function () {
                            return [
                                200,
                                {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, productServiceQuestions.meta()];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.productServiceQuestions().meta()];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('ProductServiceQuestionsGetMetaFailed');
                    return [3 /*break*/, 5];
