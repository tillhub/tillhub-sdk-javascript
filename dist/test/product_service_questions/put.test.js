...
var questionId = '0505ce68-9cd9-4b0c-ac5c-7cb6804e8956';
...
describe('v0: Product Service Question: can alter the', function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, productServiceQuestions.put(questionId, productServiceQuestion)];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.productServiceQuestions().put(questionId, productServiceQuestion)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('ProductServiceQuestionsPutFailed');
                    return [3 /*break*/, 5];
