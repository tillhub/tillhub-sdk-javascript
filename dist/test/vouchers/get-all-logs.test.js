...
describe('v0: vouchers: can get all logs', function () {
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onGet("https://api.tillhub.com/api/v0/vouchers/" + legacyId + "/logs").reply(function () {
                            return [
                                200,
                                {
                                    count: 1,
                ...
                case 1:
                    ...
                    return [4 /*yield*/, vouchers.logs.getAll()];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.vouchers().logs.getAll()];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('VouchersLogsFetchFailed');
                    return [3 /*break*/, 5];
...
//# sourceMappingURL=get-all-logs.test.js.map