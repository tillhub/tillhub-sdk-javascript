...
describe('v0: Branches: can get count number of all customers', function () {
    it("Tillhub's branches are instantiable", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var mock, legacyId_1, options, th, customers, data;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                        ...
                        mock.onPost('https://api.tillhub.com/api/v0/users/login').reply(function () {
                            return [
                                200,
                                {
                                    ...
                                    user: {
                                        id: '123',
                                        legacy_id: legacyId_1
                                    }
                                }
                            ];
                        });
                        mock.onGet("https://api.tillhub.com/api/v0/customers/" + legacyId_1 + "/meta").reply(function () {
                            return [
                                200,
                                {
                                    count: 50,
                ...
                case 1:
                    ...
                    return [4 /*yield*/, customers.count()];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var mock, legacyId_2, options, th, err_1;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onPost('https://api.tillhub.com/api/v0/users/login').reply(function () {
                            return [
                                200,
                                {
                                    ...
                                    user: {
                                        id: '123',
                                        legacy_id: legacyId_2
                                    }
                                }
                            ];
                        });
                        mock.onGet("https://api.tillhub.com/api/v0/customers/" + legacyId_2 + "/meta").reply(function () {
                            return [205];
                        });
                    }
                    options = {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.customers().count()];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('CustomersCountFailed');
                    return [3 /*break*/, 5];
