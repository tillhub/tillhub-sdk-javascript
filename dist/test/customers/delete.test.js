...
var respMsg = "Deleted customer " + customerId;
var legacyId = '4564';
var mock = new axios_mock_adapter_1.default(axios_1.default);
afterEach(function () {
    mock.reset();
});
describe('v0: customers', function () {
    it('can delete one', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var options, customer, msg;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    customer = tillhub_js_1.default.customers();
                    expect(customer).toBeInstanceOf(tillhub_js_1.v0.Customers);
                    return [4 /*yield*/, customer.delete(customerId)];
                case 2:
                    msg = (_a.sent()).msg;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.customers().delete(customerId)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('CustomerDeleteFailed');
                    return [3 /*break*/, 5];
