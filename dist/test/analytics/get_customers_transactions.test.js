...
describe('v0: Analytics: gets customers transactionsreport', function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    mockString = 'customer_id=0001&currency=EUR';
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock
                            .onGet("https://api.tillhub.com/api/v0/analytics/" + legacyId + "/reports/customers/transactions?" + mockString)
                            .reply(function () {
                            return [
                                200,
                                {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, analytics.getCustomersTransaction(mockCustomersQuery)];
                case 2:
                    data = (_a.sent()).data;
...
//# sourceMappingURL=get_customers_transactions.test.js.map