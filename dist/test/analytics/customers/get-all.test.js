...
describe('v0: Analytics: gets customers report', function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, customers.getAll()];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('takes a query string', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var mockCustomersQuery, options, th, customers, data;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockCustomersQuery = {
                ...
                case 1:
                    ...
                    customers = th.analytics().customers();
                    expect(customers).toBeInstanceOf(customers_1.Customers);
                    return [4 /*yield*/, customers.getAll(mockCustomersQuery)];
                case 2:
                    data = (_a.sent()).data;
                    expect(Array.isArray(data)).toBe(true);
                    return [2 /*return*/];
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.analytics().customers().getAll()];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('CustomerFetchFailed');
                    return [3 /*break*/, 5];
