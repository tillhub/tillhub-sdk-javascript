...
var mockString = 'voucher_number=123&redeemed_id=234&redeemed_branch=1&redeemed_email=email%40email.com&redeemed_external_custom_id=345&redeemed_at=2018-01-12T22%3A48%3A13.000Z&issuer=store&issued_at=2018-01-12T22%3A48%3A13.000Z&valid_until=2018-01-12T22%3A48%3A13.000Z&comment=someComment&q=at';
...
describe('v0: Analytics: reports gets all vouchers', function () {
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock
                            .onGet("https://api.tillhub.com/api/v0/analytics/" + legacyId + "/reports/vouchers?" + mockString)
                            .reply(function () {
                            return [
                                200,
                                {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, analytics.getVouchersReports(mockVoucherQuery)];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.analytics().getVouchersReports()];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('VouchersReportFetchFailed');
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/];
            }
        });
    }); });
    it('takes empty query sting', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var options, th, analytics, data;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    analytics = th.analytics();
                    expect(analytics).toBeInstanceOf(tillhub_js_1.v0.Analytics);
                    return [4 /*yield*/, analytics.getVouchersReports()];
                case 2:
                    data = (_a.sent()).data;
                    expect(Array.isArray(data)).toBe(true);
                    return [2 /*return*/];
...
//# sourceMappingURL=get_vouchers_reports.test.js.map