...
describe('v0: Analytics: gets revenue for  day of week', function () {
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock
                            .onGet("https://api.tillhub.com/api/v0/analytics/" + legacyId + "/aggregates/revenues/day_of_week?" + queryString)
                            .reply(function () {
                            return [
                                200,
                                {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, analytics.getRevenuesForDayOfWeek(queryObject)];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.analytics().getRevenuesForDayOfWeek(queryObject)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
...
//# sourceMappingURL=get_revenues_for_day_of_week.test.js.map