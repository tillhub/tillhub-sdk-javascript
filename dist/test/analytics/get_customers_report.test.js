...
describe('v0: Analytics: gets customers report', function () {
    it('gets customers report', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, analytics.getCustomersReport()];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('takes a query string', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var mockCustomersQuery, mockString, options, th, analytics, data;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockCustomersQuery = {
                ...
                case 1:
                    ...
                    analytics = th.analytics();
                    expect(analytics).toBeInstanceOf(tillhub_js_1.v0.Analytics);
                    return [4 /*yield*/, analytics.getCustomersReport(mockCustomersQuery)];
                case 2:
                    data = (_a.sent()).data;
                    expect(Array.isArray(data)).toBe(true);
                    return [2 /*return*/];
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.analytics().getCustomersReport()];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('ReportsCustomerCustomersFailed');
                    return [3 /*break*/, 5];
...
//# sourceMappingURL=get_customers_report.test.js.map