...
var legacyId = '4564';
var queryString = 'start=2018-07-29T14%3A55%3A05.000Z&end=2018-08-29T14%3A55%3A05.000Z&branch_number=1';
var queryObject = {
...
describe('v0: Analytics: gets revenue for each hour of day', function () {
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock
                            .onGet("https://api.tillhub.com/api/v0/analytics/" + legacyId + "/aggregates/revenues/hour_of_day?" + queryString)
                            .reply(function () {
                            return [
                                200,
                                {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, analytics.getRevenuesForHourOfDay(queryObject)];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.analytics().getRevenuesForHourOfDay(queryObject)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('RevenuesFetchFailed');
                    return [3 /*break*/, 5];
...
//# sourceMappingURL=get_revenues_for_hour_of_day.test.js.map