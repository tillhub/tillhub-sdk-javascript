...
var legacyId = '4564';
var functionId = 'abc123';
var mock = new axios_mock_adapter_1.default(axios_1.default);
afterEach(function () {
    mock.reset();
});
describe('v0: Functions: Actions: can get one', function () {
    it("Tillhub's functions are instantiable", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var options, th, functions, data;
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onGet("https://api.tillhub.com/api/v0/functions/" + legacyId + "/" + functionId).reply(function () {
                            return [
                                200,
                                {
                                    count: 1,
                ...
                case 1:
                    _a.sent();
                    functions = th.functions();
                    expect(functions).toBeInstanceOf(tillhub_js_1.v0.Functions);
                    return [4 /*yield*/, functions.get(functionId)];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.functions().get(functionId)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('FunctionFetchFailed');
                    return [3 /*break*/, 5];
