...
describe('v0: Branches Groups: can get all', function () {
    var legacyId = '4564';
    var mock = new axios_mock_adapter_1.default(axios_1.default);
    afterEach(function () {
        mock.reset();
    });
    it("Tillhub's branch groups are instantiable", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var options, th, branchGroups, data;
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onGet("https://api.tillhub.com/api/v0/branch_groups/" + legacyId).reply(function () {
                            return [
                                200,
                                {
                                    count: 1,
                ...
                case 1:
                    _a.sent();
                    branchGroups = th.branchGroups();
                    expect(branchGroups).toBeInstanceOf(tillhub_js_1.v0.BranchGroups);
                    return [4 /*yield*/, branchGroups.getAll()];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.branchGroups().getAll()];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('BranchGroupsFetchFailed');
                    return [3 /*break*/, 5];
