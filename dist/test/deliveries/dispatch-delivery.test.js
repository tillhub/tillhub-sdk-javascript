...
describe('v0: Deliveries', function () {
    it('can dispatch a delivery', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock
                            .onPost("https://api.tillhub.com/api/v0/deliveries/" + legacyId + "/" + requestObject.deliveryId + "/dispatch?embed[]=location")
                            .reply(function () {
                            return [
                                200,
                                {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, delivery.dispatchDelivery(requestObject)];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, tillhub_js_1.default.deliveries().dispatchDelivery(requestObject)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('DeliveriesDispatchFailed');
                    return [3 /*break*/, 5];
...
//# sourceMappingURL=dispatch-delivery.test.js.map