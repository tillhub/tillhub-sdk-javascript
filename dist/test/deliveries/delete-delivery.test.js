...
var respMsg = "Deleted delivery " + deliveryId;
var legacyId = '4564';
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, delivery.deleteDelivery(deliveryId)];
                case 2:
                    msg = (_a.sent()).msg;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, tillhub_js_1.default.deliveries().deleteDelivery(deliveryId)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('DeliveriesDeleteFailed');
                    return [3 /*break*/, 5];
...
//# sourceMappingURL=delete-delivery.test.js.map