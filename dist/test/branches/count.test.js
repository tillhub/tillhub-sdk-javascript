...
describe('v0: Branches: can get count number of all branches', function () {
    it("Tillhub's branches are instantiable", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var mock, legacyId_1, options, th, branches, data;
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onGet("https://api.tillhub.com/api/v0/branches/" + legacyId_1 + "/meta").reply(function () {
                            return [
                                200,
                                {
                                    count: 50,
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onGet("https://api.tillhub.com/api/v0/branches/" + legacyId_2 + "/meta").reply(function () {
                            return [205];
                        });
                    }
                    options = {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.branches().count()];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('BranchesCountFailed');
                    return [3 /*break*/, 5];
