...
var entryId = 'asdf5566';
var updateObject = {
    started_at: '123789456',
    ended_at: '123456396'
};
describe('v0: Timetracking: can alter the timetracking entry', function () {
    it("Tillhub's timetracking are instantiable", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, timetracking.updateEntry(entryId, updateObject)];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.timetracking().updateEntry(entryId, updateObject)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('TimetrackingEntryPutFailed');
                    return [3 /*break*/, 5];
...
//# sourceMappingURL=update-entry.test.js.map