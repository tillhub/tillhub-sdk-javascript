...
describe('v0: DeviceGroups: can get all', function () {
    it("Tillhub's DeviceGroups are instantiable", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var options, th, deviceGroups, data;
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onGet("https://api.tillhub.com/api/v0/device_groups/" + legacyId).reply(function () {
                            return [
                                200,
                                {
                                    count: 1,
                ...
                case 1:
                    _a.sent();
                    deviceGroups = th.deviceGroups();
                    expect(deviceGroups).toBeInstanceOf(tillhub_js_1.v0.DeviceGroups);
                    return [4 /*yield*/, deviceGroups.getAll()];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.deviceGroups().getAll()];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('DeviceGroupsFetchFailed');
                    return [3 /*break*/, 5];
