...
var respMsg = 'The requested order items were deleted';
var orderItemsDelete = {
    order: 'wert',
    auto: false,
    suggestion: true,
    order_qty: 4
};
describe('v0: Orders: can delete Order Items', function () {
    it("Tillhub's orders are instantiable", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var options, th, orders, msg;
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock
                            .onDelete("https://api.tillhub.com/api/v0/orders/" + legacyId + "/order_items?order=wert&auto=false&suggestion=true&order_qty=4")
                            .reply(function () {
                            return [
                                200,
                                {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, orders.deleteOrderItems(orderItemsDelete)];
                case 2:
                    msg = (_a.sent()).msg;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.orders().deleteOrderItems(orderItemsDelete)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('OrderItemsDeleteFailed');
                    return [3 /*break*/, 5];
...
//# sourceMappingURL=delete-order-items.test.js.map