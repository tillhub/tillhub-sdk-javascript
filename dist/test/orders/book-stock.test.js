            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock
                            .onPost("https://api.tillhub.com/api/v0/orders/" + legacyId + "/order_items/" + orderId + "/book_stock")
                            .reply(function () {
                            return [
                                200,
                                {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, orders.bookStock(bookStockRequest)];
                case 2:
                    data = (_a.sent()).data;
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock
                            .onGet("https://api.tillhub.com/api/v0/orders/" + legacyId + "/order_items/" + orderId + "/book_stock")
                            .reply(function () {
                            return [205];
                        });
                    }
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.orders().bookStock(bookStockRequest)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('BookStockFailed');
                    return [3 /*break*/, 5];
