...
describe('v1: Registers: can get all', function () {
    it("Tillhub's registers are instantiable", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onGet("https://api.tillhub.com/api/v1/registers/" + legacyId).reply(function () {
                            return [
                                200,
                                {
                                    count: 1,
                ...
                case 1:
                    ...
                    return [4 /*yield*/, registers.getAll()];
                case 2:
                    data = (_a.sent()).data;
    ...
    it("Tillhub's registers take query for branch", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var options, th, registers, data;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onGet("https://api.tillhub.com/api/v1/registers/" + legacyId + "?branch=1").reply(function () {
                            return [
                                200,
                                {
                                    count: 1,
                ...
                case 1:
                    ...
                    registers = th.registers();
                    expect(registers).toBeInstanceOf(tillhub_js_1.v1.Registers);
                    return [4 /*yield*/, registers.getAll({ branch: '1' })];
                case 2:
                    data = (_a.sent()).data;
                    expect(Array.isArray(data)).toBe(true);
                    return [2 /*return*/];
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onGet("https://api.tillhub.com/api/v0/registers/" + legacyId).reply(function () {
                            return [205];
                        });
                    }
                    options = {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.registers().getAll()];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('RegistersFetchFailed');
                    return [3 /*break*/, 5];
