...
describe('v0: Audits: Actions: can get types', function () {
    it("Tillhub's audits are instantiable", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var options, th, audits, data;
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock
                            .onGet("https://api.tillhub.com/api/v0/audits/" + legacyId + "/actions/types?" + queryString())
                            .reply(function () {
                            return [
                                200,
                                {
                                    count: 1,
                                    results: [{ types: ['carts.clear', 'register.remove'] }]
                                }
                            ];
                        });
                    }
                ...
                case 1:
                    _a.sent();
                    audits = th.auditActions();
                    expect(audits).toBeInstanceOf(tillhub_js_1.v0.AuditActions);
                    return [4 /*yield*/, audits.getTypes(query)];
                case 2:
                    data = (_a.sent()).data;
                    expect(data).toEqual([{ types: ['carts.clear', 'register.remove'] }]);
                    return [2 /*return*/];
            }
        });
    }); });
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.auditActions().getTypes(query)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('AuditActionsTypesFetchFailed');
                    return [3 /*break*/, 5];
...
//# sourceMappingURL=get-types.test.js.map