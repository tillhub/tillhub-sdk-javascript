...
var staffID = '1Q2W3E4R';
var makeUserObj = { user: '1234-asdf' };
var staffMember = {
    firstname: 'asdf',
    lastname: 'asdf',
    displayname: 'asdf',
...
describe('v0: Staff: can make a staff member a user', function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Staff.makeUser(staffID, makeUserObj)];
                case 2:
                    data = (_a.sent()).data;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    th = _a.sent();
                    return [4 /*yield*/, th.staff().makeUser(staffID, makeUserObj)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('MakeUserStaffFailed');
                    return [3 /*break*/, 5];
...
//# sourceMappingURL=make-user.test.js.map