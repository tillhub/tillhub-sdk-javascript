...
describe('v0: Staff: can get meta of staff', function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Staff.meta(query)];
                case 2:
                    data = (_a.sent()).data;
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onGet("https://api.tillhub.com/api/v0/staff/" + legacyId + "/meta").reply(function () {
                            return [205];
                        });
                    }
                    _a.label = 1;
                ...
                case 2:
                    th = _a.sent();
                    return [4 /*yield*/, th.staff().meta(query)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('StaffMetaFailed');
                    return [3 /*break*/, 5];
