...
var staffId = 'asdf5566';
var respMsg = "Deleted staff " + staffId;
describe('v0: Staff: can alter the Staff member', function () {
            ...
            switch (_a.label) {
                case 0:
                    if (process.env.SYSTEM_TEST !== 'true') {
                        ...
                        mock.onDelete("https://api.tillhub.com/api/v0/staff/" + legacyId + "/" + staffId).reply(function () {
                            return [
                                200,
                                {
                                    msg: respMsg
                ...
                case 1:
                    ...
                    return [4 /*yield*/, staff.delete(staffId)];
                case 2:
                    msg = (_a.sent()).msg;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.staff().delete(staffId)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('StaffDeleteFailed');
                    return [3 /*break*/, 5];
