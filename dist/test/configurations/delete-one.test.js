...
var configurationId = 'abc123';
var respMsg = "Deleted configuration " + configurationId;
var legacyId = '4564';
var mock = new axios_mock_adapter_1.default(axios_1.default);
afterEach(function () {
    mock.reset();
});
describe('v0: configurations', function () {
    it('can delete one', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var options, configuration, msg;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    configuration = tillhub_js_1.default.configurations();
                    expect(configuration).toBeInstanceOf(tillhub_js_1.v0.Configurations);
                    return [4 /*yield*/, configuration.delete(configurationId)];
                case 2:
                    msg = (_a.sent()).msg;
    ...
    it('rejects on status codes that are not 200', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, th.configurations().delete(configurationId)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    expect(err_1.name).toBe('ConfigurationDeleteFailed');
                    return [3 /*break*/, 5];
...
//# sourceMappingURL=delete-one.test.js.map