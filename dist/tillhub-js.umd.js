(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tty'), require('util'), require('url'), require('http'), require('https'), require('assert'), require('stream'), require('zlib'), require('events')) :
    typeof define === 'function' && define.amd ? define(['exports', 'tty', 'util', 'url', 'http', 'https', 'assert', 'stream', 'zlib', 'events'], factory) :
    (factory((global.tillhubJs = {}),global.tty,global.util,global.url,global.http,global.https,global.assert,global.stream,global.zlib,global.EventEmitter));
}(this, (function (exports,tty,util,url,http,https,assert,stream,zlib,EventEmitter) { 'use strict';
    ...
    ***************************************************************************** */
        ...
        Auth.prototype.authenticate = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, [new AuthenticationFailed('No auth data was provided'), null]];
                });
            });
        };
    ...
    var Transactions = /** @class */ (function () {
        function Transactions(options, http$$1) {
            this.options = options;
            this.http = http$$1;
     ...
     * @extends "v0.Auth"
     */
    var Auth$1 = /** @class */ (function (_super) {
        __extends(Auth$$1, _super);
        function Auth$$1(options) {
        ...
        Auth$$1.prototype.loginServiceAccount = function (authData) {
            return __awaiter(this, void 0, void 0, function () {
                var response, err_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, axios$1.post(this.options.base + "/api/v1/users/auth/key", {
                                    id: authData.id,
    ...
    var tillhubJs = Tillhub.getInstance({ base: defaultOptions.base });
