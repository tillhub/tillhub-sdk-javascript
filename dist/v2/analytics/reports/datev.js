...
var AnalyticsReportsDatev = /** @class */ (function (_super) {
    __extends(AnalyticsReportsDatev, _super);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.handleExport(this.options.base + "/api/v2/analytics/" + this.options.user + "/reports/datev", query)];
                    case 1:
                        result = _a.sent();
...
var AnalyticsReportsDatevExportFetchError = /** @class */ (function (_super) {
    __extends(AnalyticsReportsDatevExportFetchError, _super);
