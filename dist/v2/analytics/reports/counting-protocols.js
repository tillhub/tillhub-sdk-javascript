            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        nextFn = void 0;
                        return [4, this.handleGet(this.options.base + "/api/v2/analytics/" + this.options.user + "/reports/cashier_counting_protocols/overview", query)];
                    case 1:
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, this.handleExport(this.options.base + "/api/v2/analytics/" + this.options.user + "/reports/cashier_counting_protocols/overview", query)];
                    case 1:
                        result = _a.sent();
                        return [2, result];
                    case 2:
